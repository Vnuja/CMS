    ...
    return (
        <Box sx={{ p: 4 }}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'flex-end', mb: 2 }}>
                <Button variant="contained" startIcon={<ReceiptIcon />} sx={{ marginRight: 1 }} component={Link} to="/attendance-reports">
                    Attendance Reports
                </Button>
                <Button variant="contained" startIcon={<AssignmentIcon />} color component={Link} to="/leave-requests">
                    Leave Requests
                </Button>
            </Box>
